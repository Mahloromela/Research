...
class GameSimulator:
    ...
    def __init__(self,
                 ...
                 save_path: Path = Path("game_performance_data"),
        ...
        try:
            while game_instance.check_winner() == "In Progress":
                ...
                if winner != "In Progress":
                    ...
                    game_metrics = self.calculate_game_metrics(stage_metrics, player_metrics, total_duration,
                                                               game_instance.current_player.name)
...
if __name__ == "__main__":
    simulator = GameSimulator(num_games=6, visualize=True,
                              save_path=Path("game_performance_data"))
