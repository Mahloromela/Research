...
class NNAgent:
    ...
    def create_value_model(self):
        ...
        attention_scores = Dense(32, activation='softmax')(inputs)
    ...
    def train(self, X_placement, v_placement, X_movement, v_movement, X_jumping,
        ...
        self.history_placement = self.placement_value_model.fit(X_train_placement, y_train_placement, epochs=50,
        ...
        #                                                       callbacks=[monitor_weights_callback, movement_checkpoint],batch_size=10)
        ...
        #                                                     callbacks=[monitor_weights_callback, jumping_checkpoint], batch_size=16)
...
def save_model_with_unique_name(base_name):
    file_name = rf'/home/vmuser/Pictures/Code/Morabaraba/Training5/MSL Model/{base_name}.keras'

    if os.path.exists(file_name):
        timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
        file_name = rf'/home/vmuser/Pictures/Code/Morabaraba/Training5/MSL Model/{base_name}_{timestamp}.keras'
